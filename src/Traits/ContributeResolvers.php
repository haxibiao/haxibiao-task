...
trait ContributeResolvers
{
    /**
     * Draw广告奖励
     * Contribute::DRAW_AD_CONTRIBUTED_TYPE, contributes表中 Draw广告 morph type 值
     * Contribute::DRAW_AD_CONTRIBUTED_ID, contribute表中 Draw广告 morph id 值
     * @param $rootValue
     * @param array $args
     * @param $context
     * @param $resolveInfo
...
//          兼容旧版本
     ...
     * Contribute::REWARD_VIDEO_CONTRIBUTED_TYPE,contributes表中 激励视频 morph type 值
     * Contribute::REWARD_VIDEO_CONTRIBUTED_ID,contributes表中 激励视频 morph id 值
     *
     * @param $rootValue
     * @param array $args
     * @param $context
...
//    兼容旧版本Feed
    ...
    /**
     * 目前正在使用的点击Feed广告奖励
     * Contribute::AD_FEED_CONTRIBUTED_TYPE,morph Type
     * Contribute::AD_FEED_CONTRIBUTED_ID,morph Id
     * @param $rootValue
     * @param array $args
     * @param $context
     * @param $resolveInfo
